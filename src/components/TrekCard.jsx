    ...
    <div className="group relative bg-white border border-charcoal/10 overflow-hidden card-lift">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => onBook(trek)} className={`btn-sheen px-4 py-2 bg-charcoal text-cream text-xs font-bold tracking-wide uppercase hover:bg-heritage transition-colors ${isMr ? 'font-marathi' : ''}`}>
            {tr('bookNow', isMr)}
          </button>
        </div>
      </div>
